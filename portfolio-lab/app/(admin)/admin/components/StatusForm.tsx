            ...
            <form action={updateStatus} className=" flex flex-col gap-4">
                ...
                <div className="relative w-full font-jetBrains-mono text-xs">
                    ...
                    <button
                        ...
                        className="w-full py-2 px-4 text-center border border-amber-500/30 bg-black text-amber-500/80 hover:bg-amber-500/10 hover:border-amber-500 transition-all rounded-md flex items-center justify-between cursor-pointer"
                    >
                    ...
                    <button type="submit" className="rounded-full px-2 py-1 text-xs w-fit lg:w-full text-center border border-amber-500  font-jetBrains-mono text-amber-500/80 hover:cursor-pointer ">хуяк</button>
